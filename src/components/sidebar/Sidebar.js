...
const Sidebar = () => {
  return (
    <div className='sidebar'>
      ...
      <span className='comm'><img alt="vision" className='profile-comm' src={profileOri}/></span><span className='fnt'>Jeneeta</span>
      </div>
      <div className='sidebar-wrap'>
        <span className='find_friend comm'></span><span className='fnt'>Find friends</span>
      </div>
      <div className='sidebar-wrap'>
        <span className='comm'><img alt="vision" src={Icon}/></span><span className='fnt'>Most recent</span>
      </div>
      <div className='sidebar-wrap'>
      ...
      <div className='sidebar-wrap'>
        <span className='comm'><img alt="vision" src={Fav}/></span><span className='fnt'>Favourites</span>
      </div>
    </div>
  )
}
